...
<table class="table table-hover">
  ...
  <tr class="table-secondary">
    ...
    <td style="width: 50px;"><p data-placement="top" data-toggle="tooltip" title="Edit" ><button class="btn btn-success btn-xs" data-title="Edit" data-toggle="modal" data-target="#edit" onclick="location.href='<?php echo base_url(); ?>requestitems/edit/<?php echo ($req['req_id']); ?> ';"  ><i class="fa fa-pencil fa-fw" aria-hidden="true"></i></button></p></td>
    <?php echo form_open('requestitems/delete/' .$req['req_id']) ?>
