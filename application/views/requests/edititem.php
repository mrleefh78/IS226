...
echo form_open('requests/edititem', $entries); ?>
  <fieldset>
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="uom" name="uom"  aria-describedby="uom" placeholder="Unit" value = "<?php echo $request['unit']; ?>">
