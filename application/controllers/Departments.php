<?php
    ...
    class Departments extends CI_Controller {
        public function index(){
            ...
            $data['departments'] =  $this->supplier_model->get_departments();
        ...
        public function view($department_id = NULL){
            ...
            $data['department'] =  $this->supplier_model->get_departments($department_id);
        ...
        public function create(){
            ...
            if( $this->form_validation->run()===FALSE){
                ...
                if ($this->supplier_model->create_department())
                    {                             
        ...
        public function edit($id = NULL){
            $data['department'] =  $this->supplier_model->get_departments($id);
            if(empty($data['department'])){
                show_404();
            }
        ...
        public function update($id){
            $this->supplier_model->update_department($id);
            redirect('departments');
        }

        public function delete($id){
            $this->supplier_model->delete_department($id);
            redirect('departments');
        }
